...
const practiceInfoElem = document.getElementById("modal-practice-info");
...
document.getElementById("editNoteForm").addEventListener("submit", function (e) {
    ...
    // Verificar si la nota tiene un formato válido (solo números y coma como separador decimal)
